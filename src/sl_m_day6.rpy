label slavyana_mod__day6:
  ...
  if d5_make_semen_guilty:
    "Её намеки не оставляли мне выбора, и я решила прояснить ситуацию."
    sl "Просто Семён себя совершенно по-глупому повёл!"
    sl "Я говорила ему, что сама дойду до медпункта, а он увязался проводить меня, ещё и остался здесь, никак не реагируя на мои уговоры."
    sl "Вот нас Ольга Дмитриевна и увидела вместе, не знаю что она себе надумала там, а мы ничем и не занимались вовсе."
    "Виола, всё это время внимательно слушавшая меня, вдруг перестала улыбаться, а её лицо словно излучало профессионализм медработника."
    cs "В любом случае, у меня строгий наказ от Ольги никого не впускать и никого не выпускать."
    "На этом её расспросы закончились, и я прилегла отдохнуть."
  else:
    sl "Это моя вина."
    "Виола удивлённо посмотрела на меня."
    sl "Не надо было мне просить Семёна проводить меня, ведь знала, что так и будет."
    sl "А потом мне ещё холодно стало, он мне и так свой свитер отдал."
    sl "А мне всё равно было холодно и я никак согреться не могла, вот и попросила его лечь рядом{w}, просто прилечь."
    sl "И как невовремя пришла Ольга Дмитриевна, застала нас вместе и.. Дальше вы сами знаете."
    "Наша медсестра, на удивление, поубавила пыл и посмотрела на меня, словно с пониманием."
    cs "Сама молодой была, знаю каково это, но и вожатую свою тоже пойми, ей же влетит за вас в случае чего."
    cs "Был один инцидент несколько лет назад.."
    "Начала она, но вдруг остановилась."
    cs "В общем, у неё есть все основания быть такой осторожной."
    "Я кивнула, по крайней мере, она дала мне возможность высказаться."
    "Я легла обратно на кушетку."
  window hide
