...
label slavyana_mod__day4_bknt7:
  $ sl_m_nb_add(" Придя на место, я немного струхнула уже от самого вида лагеря. Но вот Семён пошёл вперёд и я за ним.")
  $ sl_m_nb_add2("Мы зашли внутрь и осмотрели здание. Всё это время я пыталась не отходить далеко от Семёна.")
  return
