...
label slavyana_mod__day4_after_map_choise:
  ...
  menu:
    "Не обращать внимания":
      ...
      "Но также мне сегодня помогал и Семён, во всяком случае, мы вместе обошли лагерь." 
      
      "После ужина Алиса и Ульянка хотели взорвать памятник Генде. До сих пор не могу вспомнить, кто он такой, но ведь это не повод его взрывать!"
      "Потом на площадь неожиданно забежал Электроник с ботинком Шурика в руке. По его словам, он нашёл его на дороге в старый лагерь. Не знаю, чем бы это всё кончилось, но Семён отказался идти туда в одиночку. Хотя я его понимаю. Он здесь совсем недавно, а его уже посылают на такое рискованное задание. (остановка) Может, стоило отправиться вместе с ним?"
      "Ольга Дмитриевна сказала, что завтра отправимся все вместе. Наверное, так даже лучше."
