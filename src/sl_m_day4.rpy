...
label slavyana_mod__day4_after_map_choise:
  ...
  show screen sl_m_nb() with dissolve
  window show
  th "Нам пришлось спуститься в пролом в полу. Мы оказались в заброшенной шахте. К этому моменту я уже ни на минуту не отпускала руку Семёна, который неумолимо шёл вперёд."
  window hide
  call slavyana_mod__day4_bknt10_1
  show screen sl_m_nb() with dissolve
  window show
  extend " Мы миновали развилки, несколько десятков минут плутали по этому лабиринту, но всё-таки нашли Шурика."
  window hide
...
label slavyana_mod__day4_bknt7:
  $ sl_m_nb_add2(" Придя на место, я немного струхнула уже от самого вида лагеря. Но вот Семён пошёл вперёд и я за ним. Мы зашли внутрь и осмотрели здание. Всё это время я пыталась не отходить далеко от Семёна.")
  return
...
label slavyana_mod__day4_bknt10:
  $ sl_m_nb_add2("Нам пришлось спуститься в пролом в полу. Мы оказались в заброшенной шахте. К этому моменту я уже ни на минуту не отпускала руку Семёна, который неумолимо шёл вперёд.")
  return
label slavyana_mod__day4_bknt10_1:
  $ sl_m_nb_addpage("Мы миновали развилки, несколько десятков минут плутали по этому лабиринту, но всё-таки нашли Шурика.")
  return
label slavyana_mod__day4_bknt11:
  $ sl_m_nb_add("Бедняге слышались голоса, и мне пришлось его успокаивать, чтобы вернуть его в «Совёнок».")
  return
label slavyana_mod__day4_bknt12:
  $ sl_m_nb_add("Всё закончилось благополучно, и все вернулись домой. Когда Шурик ушёл, мы ещё некоторое время сидели вместе с Семёном. Там, на площади, мне так не хотелось уходить, создавалось чувство какой-то недосказанности.")
  return
