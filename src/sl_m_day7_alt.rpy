label slavyana_mod__day7_alt:
  ...
  if sl_m_end_dv:
    ...
    "Это был клочек бумаги. Немного порваный. {w}Я решила достать его."
  ...
  #убрать картинку записки
    ...
    th "Маленький листок никому не повредит. Зато какие приятные эммоции может доставить следующей смене."
